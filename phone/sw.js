const CACHE='nfpl-phone-v3.7.6-icon-v3772';
const ASSETS=['/phone/','/phone/index.html','/phone/app-v376.html?v=3771','/phone/manifest.webmanifest?v=3772','/phone/icon-192.png?v=3772','/phone/icon-512.png?v=3772','/phone/favicon.png?v=3772','/phone/apple-touch-icon.png?v=3772'];
